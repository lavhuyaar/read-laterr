...
> = {
  ...
  meta: {
    modelProps: 'user' | 'authMethod' | 'book' | 'userBook';
    ...
    AuthMethod: {
      ...
      operations: {
        ...
        count: {
          ...
          result:
            | runtime.Types.Utils.Optional<Prisma.AuthMethodCountAggregateOutputType>
            | number;
        };
      };
    };
    ...
    UserBook: {
      ...
      operations: {
        ...
        count: {
          ...
          result:
            | runtime.Types.Utils.Optional<Prisma.UserBookCountAggregateOutputType>
            | number;
        };
      };
    };
...
export type AuthMethodScalarFieldEnum =
  (typeof AuthMethodScalarFieldEnum)[keyof typeof AuthMethodScalarFieldEnum];
...
export type UserBookScalarFieldEnum =
  (typeof UserBookScalarFieldEnum)[keyof typeof UserBookScalarFieldEnum];
